...
require (
	buf.build/gen/go/astria/primitives/protocolbuffers/go v1.34.0-20240503161156-3834337790f5.1
	buf.build/gen/go/astria/protocol-apis/protocolbuffers/go v1.34.0-20240503161158-51dc03524950.1

...
require (
	buf.build/gen/go/astria/primitives/protocolbuffers/go v1.34.0-20240502202318-0e551ec7f894.1
	buf.build/gen/go/astria/protocol-apis/protocolbuffers/go v1.34.0-20240502202321-1640f371fb46.1

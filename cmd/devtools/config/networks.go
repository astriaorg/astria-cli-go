...
func NewBaseConfig(instanceName string) BaseConfig {
	...
	return BaseConfig{
		...
		Astria_composer_sequencer_chain_id:         "astria-dusk-6",
		Astria_composer_rollups:                    "astriachain::ws://127.0.0.1:8546",
		Astria_composer_private_key_file:           filepath.Join(homePath, ".astria", instanceName, DefaultConfigDirName, "dev_priv_key"),

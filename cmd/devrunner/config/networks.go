...
func NewBaseConfig(instanceName string) BaseConfig {
	...
	return BaseConfig{
		...
		Astria_composer_sequencer_chain_id:         "astria-dusk-8",
...
func DefaultNetworksConfigs() NetworkConfigs {
	config := NetworkConfigs{
		...
		Dusk: NetworkConfig{
			SequencerChainId: "astria-dusk-8",
			SequencerGRPC:    "https://grpc.sequencer.dusk-8.devnet.astria.org/",
			SequencerRPC:     "https://rpc.sequencer.dusk-8.devnet.astria.org/",
			RollupName:       "",
			NativeDenom:      "nria",
		},
		Dawn: NetworkConfig{

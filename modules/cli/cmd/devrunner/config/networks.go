			...
			"local": {
				...
				Services: map[string]ServiceConfig{
					"conductor": {
						...
						DownloadURL: ServiceUrls.BuildAstriaConductorReleaseUrl(LocalConductorVersion),
					...
					"composer": {
						...
						DownloadURL: ServiceUrls.BuildAstriaComposerReleaseUrl(LocalComposerVersion),
					...
					"cometbft": {
						...
						DownloadURL: ServiceUrls.BuildCometBftReleaseUrl(LocalCometbftVersion),
			...
			"dusk": {
				...
				Services: map[string]ServiceConfig{
					"conductor": {
						...
						DownloadURL: ServiceUrls.BuildAstriaConductorReleaseUrl(AstriaConductorVersion),
					...
					"composer": {
						...
						DownloadURL: ServiceUrls.BuildAstriaComposerReleaseUrl(AstriaComposerVersion),

			...
			"local": {
				...
				Services: map[string]ServiceConfig{
					"conductor": {
						...
						DownloadURL: ServiceUrls.BuildAstriaConductorReleaseUrl(MainnetAstriaConductorVersion),
					...
					"composer": {
						...
						DownloadURL: ServiceUrls.BuildAstriaComposerReleaseUrl(MainnetAstriaComposerVersion),
					...
					"sequencer": {
						...
						DownloadURL: ServiceUrls.BuildAstriaSequencerReleaseUrl(MainnetAstriaSequencerVersion),
					...
					"cometbft": {
						...
						DownloadURL: ServiceUrls.BuildCometBftReleaseUrl(MainnetCometbftVersion),
			...
			"dusk": {
				...
				Services: map[string]ServiceConfig{
					"conductor": {
						...
						DownloadURL: ServiceUrls.BuildAstriaConductorReleaseUrl(DevnetConductorVersion),
					...
					"composer": {
						...
						DownloadURL: ServiceUrls.BuildAstriaComposerReleaseUrl(DevnetComposerVersion),
			...
			"dawn": {
				...
				Services: map[string]ServiceConfig{
					"conductor": {
						...
						DownloadURL: ServiceUrls.BuildAstriaConductorReleaseUrl(TestnetConductorVersion),
					...
					"composer": {
						...
						DownloadURL: ServiceUrls.BuildAstriaComposerReleaseUrl(TestnetComposerVersion),

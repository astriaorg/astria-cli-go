			...
			"local": {
				...
				Services: map[string]ServiceConfig{
					"conductor": {
						...
						Version:     "v" + LocalConductorVersion,
						DownloadURL: DownloadUrlParts.AstriaConductor.UrlPrefix + LocalConductorVersion + DownloadUrlParts.AstriaConductor.UrlSuffix,
						LocalPath:   filepath.Join(defaultBinDir, "astria-conductor-v"+LocalConductorVersion),
						Args:        nil,
					},
					"composer": {
						Name:        "astria-composer",
						Version:     "v" + LocalComposerVersion,
						DownloadURL: DownloadUrlParts.AstriaComposer.UrlPrefix + LocalComposerVersion + DownloadUrlParts.AstriaComposer.UrlSuffix,
						LocalPath:   filepath.Join(defaultBinDir, "astria-composer-v"+LocalComposerVersion),
						Args:        nil,
					},
					"sequencer": {
						Name:        "astria-sequencer",
						Version:     "v" + LocalSequencerVersion,
						DownloadURL: DownloadUrlParts.AstriaSequencer.UrlPrefix + LocalSequencerVersion + DownloadUrlParts.AstriaSequencer.UrlSuffix,
						LocalPath:   filepath.Join(defaultBinDir, "astria-sequencer-v"+LocalSequencerVersion),
						Args:        nil,
					},
					"cometbft": {
						Name:        "cometbft",
			...
			"dusk": {
				...
				Services: map[string]ServiceConfig{
					"conductor": {
						...
						DownloadURL: DownloadUrlParts.AstriaConductor.UrlPrefix + AstriaConductorVersion + DownloadUrlParts.AstriaConductor.UrlSuffix,
					...
					"composer": {
						...
						DownloadURL: DownloadUrlParts.AstriaComposer.UrlPrefix + AstriaComposerVersion + DownloadUrlParts.AstriaComposer.UrlSuffix,

...
| `dev reset config`        | Reset the Cometbft config files.                                                    |
| `dev reset env`           | Reset the environment files.                                                        |
| `dev reset state`         | Reset the seqeuencer state.                                                         |
| `dev purge binaries`      | Delete all binaries for a given instance.                                           |
| `dev purge all`           | Delete the entire instance.                                                         |
